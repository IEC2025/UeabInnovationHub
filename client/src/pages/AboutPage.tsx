        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 perspective-container">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-2">
              ...
              />
              <div className="p-5">
                <h3 className="text-xl font-bold text-primary">Dr. David Nyangau</h3>
                <p className="text-secondary font-medium mb-3">Director</p>
                <p className="text-neutral-600 text-sm mb-4">
                  Ph.D. in Entrepreneurship with over 15 years of experience in business incubation and academic leadership.
                </p>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-2">
              ...
              />
              <div className="p-5">
                <h3 className="text-xl font-bold text-primary">Prof. Elizabeth Wangai</h3>
                <p className="text-secondary font-medium mb-3">Deputy Director</p>
                <p className="text-neutral-600 text-sm mb-4">
                  Professor of Business with expertise in innovation strategy and technology commercialization from Stanford University.
                </p>
                <div className="flex space-x-3">
                  <a href="#" className="text-neutral-400 hover:text-primary transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
